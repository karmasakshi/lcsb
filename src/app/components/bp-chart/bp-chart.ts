import { ChangeDetectionStrategy, Component, effect, input, InputSignal, untracked } from '@angular/core';
...
export class BpChart {
  ...
  public constructor() {
    ...
    this.options = {
      ...
      xAxis: {
        title: { text: 'Blood Pressure', style: { font: 'var(--mat-sys-body-small)' } },
        labels: { style: { font: 'var(--mat-sys-body-small)' } }
      },
      yAxis: {
        title: { text: 'Frequency', style: { font: 'var(--mat-sys-body-small)' } },
        labels: { style: { font: 'var(--mat-sys-body-small)' } }
      },
      legend: {
        itemStyle: {
